        ...
        try {
            ...
            if (usernameOrEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                if (jwtService.isTokenValid(jwt, userDetails) && userDetails.isAccountNonLocked()
                        && userDetails.isAccountNonExpired() && userDetails.isCredentialsNonExpired() && userDetails.isEnabled()) {
            ...
            // Token is invalid/expired - clear context and proceed filter chain to let AuthenticationEntryPoint handle 401
