...
public class TransportRouteController {
    ...
    @PostMapping
    public ResponseEntity<TransportRouteResponse> create(@RequestBody TransportRouteRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.create(request));
    }

    @GetMapping("/{id}")
    public ResponseEntity<TransportRouteResponse> getById(@PathVariable Long id) {
        return ResponseEntity.ok(service.getById(id));
    }

    @GetMapping
    public ResponseEntity<Page<TransportRouteResponse>> getAll(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TransportRouteResponse> update(@PathVariable Long id, @RequestBody TransportRouteRequest request) {
