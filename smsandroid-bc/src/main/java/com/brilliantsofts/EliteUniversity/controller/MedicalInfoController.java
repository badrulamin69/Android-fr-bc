...
public class MedicalInfoController {
    ...
    @PostMapping
    public ResponseEntity<MedicalInfoResponse> create(@RequestBody MedicalInfoRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.create(request));
    }

    @GetMapping("/{id}")
    public ResponseEntity<MedicalInfoResponse> getById(@PathVariable Long id) {
        return ResponseEntity.ok(service.getById(id));
    }

    @GetMapping
    public ResponseEntity<Page<MedicalInfoResponse>> getAll(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<MedicalInfoResponse> update(@PathVariable Long id, @RequestBody MedicalInfoRequest request) {
