...
public class AdmissionTestQuestionController {
    ...
    @PostMapping
    public ResponseEntity<AdmissionTestQuestionResponse> create(@RequestBody AdmissionTestQuestionRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.create(request));
    }

    @GetMapping("/{id}")
    public ResponseEntity<AdmissionTestQuestionResponse> getById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<AdmissionTestQuestionResponse> update(@PathVariable Long id, @RequestBody AdmissionTestQuestionRequest request) {
    ...
    @GetMapping("/count")
    public ResponseEntity<Map<String, Object>> count(@RequestParam Long testId) {
