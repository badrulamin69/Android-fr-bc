...
public class CourseMaterialController {
    ...
    @PostMapping
    public ResponseEntity<CourseMaterialResponse> create(@RequestBody CourseMaterialRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.create(request));
    }

    @GetMapping("/{id}")
    public ResponseEntity<CourseMaterialResponse> getById(@PathVariable Long id) {
        return ResponseEntity.ok(service.getById(id));
    }

    @GetMapping
    public ResponseEntity<Page<CourseMaterialResponse>> getAll(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CourseMaterialResponse> update(@PathVariable Long id, @RequestBody CourseMaterialRequest request) {
