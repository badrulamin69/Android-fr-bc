...
public class AcademicPolicyController {
    ...
    @PostMapping
    public ResponseEntity<AcademicPolicyResponse> create(@RequestBody AcademicPolicyRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.create(request));
    }

    @GetMapping("/{id}")
    public ResponseEntity<AcademicPolicyResponse> getById(@PathVariable Long id) {
        return ResponseEntity.ok(service.getById(id));
    }

    @GetMapping
    public ResponseEntity<Page<AcademicPolicyResponse>> getAll(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<AcademicPolicyResponse> update(@PathVariable Long id, @RequestBody AcademicPolicyRequest request) {
