...
import com.brilliantsofts.EliteUniversity.service.ReportTemplateService;
...
public class ReportTemplateController {
    ...
    @GetMapping
    public ResponseEntity<Page<ReportTemplateResponse>> getAll(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ReportTemplateResponse> update(@PathVariable Long id, @RequestBody ReportTemplateRequest request) {
