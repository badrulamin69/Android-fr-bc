...
public class EventRegistrationController {
    ...
    @GetMapping
    public ResponseEntity<Page<EventRegistrationResponse>> getAll(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EventRegistrationResponse> update(@PathVariable Long id, @RequestBody EventRegistrationRequest request) {
