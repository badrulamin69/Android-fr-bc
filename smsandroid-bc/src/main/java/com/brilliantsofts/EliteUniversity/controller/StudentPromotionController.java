...
public class StudentPromotionController {
    ...
    @PostMapping
    public ResponseEntity<StudentPromotionResponse> create(@RequestBody StudentPromotionRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.create(request));
    }

    @GetMapping("/{id}")
    public ResponseEntity<StudentPromotionResponse> getById(@PathVariable Long id) {
        return ResponseEntity.ok(service.getById(id));
    }

    @GetMapping
    public ResponseEntity<Page<StudentPromotionResponse>> getAll(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<StudentPromotionResponse> update(@PathVariable Long id, @RequestBody StudentPromotionRequest request) {
