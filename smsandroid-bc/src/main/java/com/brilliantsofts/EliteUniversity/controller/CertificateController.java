...
public class CertificateController {
    ...
    @PostMapping
    public ResponseEntity<CertificateResponse> create(@RequestBody CertificateRequest request) {
    ...
    @GetMapping
    public ResponseEntity<Page<CertificateResponse>> getAll(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CertificateResponse> update(@PathVariable Long id, @RequestBody CertificateRequest request) {
